...
export class SettingsView extends BaseView {
  ...
  public constructor(private readonly state: AppState, private readonly onThemeChange: (theme: "light" | "dark") => void, private readonly persistence?: StoragePersistenceService, private readonly folder?: DesktopLibraryFolderService,
    private readonly oneDrive?: { connections: OneDriveConnections; open(sourceId: string): void }) { super(); }
  public override unmount(): void { this.externalPanel?.unmount(); this.externalPanel = null; super.unmount(); }
  public render(): HTMLElement {
    ...
    }); card.append(choices); section.append(card, this.languageCard(), this.storageCard());
