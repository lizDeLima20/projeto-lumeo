...
export type RouteName = "login" | "register" | "privacy" | "onboarding" | "home" | "library" | "explore" | "catalog-book" | "catalog-admin" | "genre" | "settings" | "device-conflict" | "import" | "book" | "reader" | "edit-book";
