...
export const PT_BR = {
  ...
  "catalog.findBook": "Buscar", "catalog.searching": "Procurando livro…", "catalog.found": "Livro encontrado.", "catalog.download": "Baixar", "catalog.preparingDownload": "Preparando download…", "catalog.downloadBook": "Baixar livro", "catalog.downloadStarted": "Download iniciado. Quando terminar, adicione o arquivo ao Lumeo.", "catalog.addToLumeo": "Adicionar ao Lumeo", "catalog.addToLibrary": "Adicionar à biblioteca", "catalog.chooseLumeoFolder": "Escolha a pasta Lumeo dentro de Downloads.", "catalog.selectExpectedFile": "Selecione: {filename}", "catalog.fileMismatch": "O arquivo selecionado não corresponde ao livro do catálogo.",
